                  ...
                  >
                    ...
                    <td className="p-3">
                      <button
                        onClick={(e) => {
                          e.stopPropagation()
                          const link = 'https://cdn.statically.io/gh/mendiolanivelle/marketing-department-website/master/public/view-acceptance.html?id=' + sub.id
