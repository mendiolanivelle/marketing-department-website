    ...
    <div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-16 text-center border-2 border-dashed border-indigo-200">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-10 rounded-2xl bg-gradient-to-br from-indigo-600 to-purple-600 text-white">
