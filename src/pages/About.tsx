  ...
  return (
    <div>
      <section className="pt-20 pb-12 sm:pt-28 sm:pb-16 px-4 sm:px-6 text-center bg-white">
        <h1 className="text-3xl sm:text-5xl font-extrabold text-gray-900 mb-3 sm:mb-4 tracking-tight">About Our Department</h1>
        <p className="text-base sm:text-lg text-gray-500 max-w-2xl mx-auto">Learn about the Marketing department's mission, structure, and how we support the organization</p>
      </section>

      <section className="py-12 sm:py-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 items-center">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-5">Who We Are</h2>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 sm:p-16 text-center border-2 border-dashed border-gray-200">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div key={i} className="bg-white p-6 sm:p-8 rounded-2xl text-center border border-gray-200 hover:-translate-y-1 hover:shadow-lg transition-all">
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
          <div className="p-6 sm:p-10 rounded-2xl bg-gray-900 text-white">
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center mb-8 sm:mb-12">Department Structure</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div key={i} className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-200 hover:-translate-y-1 hover:shadow-lg transition-all">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">{team.title}</h3>
