...
export default function Home() {
  return (
    <div className="min-h-screen">
      <section className="pt-32 pb-20 px-6 text-center bg-gradient-to-b from-orange-50 to-white">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">
            Welcome to the <span className="bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 bg-clip-text text-transparent">Marketing Hub</span>
          </h1>
          <p className="text-xl text-gray-600 mb-10 leading-relaxed">
            Your central portal for department resources, campaign requests, brand assets, and team updates.
          </p>
          <div className="flex gap-4 justify-center flex-wrap">
            <Link to="/contact" className="px-8 py-3.5 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition shadow-lg shadow-orange-200">
              Submit a Request
            </Link>
            <Link to="/services" className="px-8 py-3.5 bg-white text-gray-700 font-semibold rounded-xl border-2 border-gray-200 hover:border-orange-500 hover:text-orange-500 transition">
              Our Services
            </Link>
          </div>
        </div>
              ...
              {announcements.map((item) => (
                <li key={item.id} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg gap-3">
                  <div className="flex items-center gap-2.5">
                    <span className="bg-orange-100 text-orange-600 px-2.5 py-0.5 rounded-md text-xs font-semibold whitespace-nowrap">
                      {item.tag}
                    </span>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              {quickLinks.map((link, i) => (
                <a key={i} href={link.href} className="flex items-center gap-2.5 p-3 bg-gray-50 rounded-lg text-gray-700 text-sm font-medium hover:bg-orange-50 hover:text-orange-500 transition">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-8 rounded-2xl border border-gray-200 hover:border-orange-200 hover:shadow-xl hover:-translate-y-1 transition-all bg-white">
