-- Consolidated acceptance_forms table creation (safe to run even if table exists)
...
DO $$
BEGIN
  DROP POLICY IF EXISTS "Anyone can insert acceptance forms" ON acceptance_forms;
  DROP POLICY IF EXISTS "Anyone can view acceptance forms" ON acceptance_forms;
  DROP POLICY IF EXISTS "Anyone can update acceptance forms" ON acceptance_forms;
  DROP POLICY IF EXISTS "Anyone can delete acceptance forms" ON acceptance_forms;
END $$;
